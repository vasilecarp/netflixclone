...
class VideoModelTestCase(TestCase):
    def setUp(self):
        ...
        self.obj_b = Video.objects.create(title='This is my title', state = PublishStateOptions.PUBLISH, video_id='abc123')
    ...
    def test_publish_case(self):
        ...
        now = timezone.now()
        published_qs = Video.objects.filter(state=PublishStateOptions.PUBLISH, publish_timestamp__lte=timezone.now())
